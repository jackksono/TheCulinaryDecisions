...
const Media = () => {
  ...
  return (
    <div>
      ...
      <div className='z-10 flex items-center justify-center pt-20 space-x-4 font-sans text-5xl italic text-black underline'>Check Out Media Related Articles</div>

      <div ref={zoom1Ref}>
        <Zoom bottom duration={1500} when={zoom1InView}>
